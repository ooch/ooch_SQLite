...
InstanceObject* ClassObject_New();
...
InstanceSQLiteDB *ClassSQLiteDB_New();
static ClassSQLiteDB *sqlite_db_class_vars;
static InstanceMethodsSQLiteDB *sqlite_db_instance_method_ptrs;
static ClassMethodsSQLiteDB *sqlite_db_class_method_ptrs;
static BOOL class_is_uninitialized = 1;
InstanceSQLiteDB *SQLiteDB()
{
...
void ClassSQLiteDB_Initialize()
{
    if ( class_is_uninitialized )
    {
        ...
        sqlite_db_instance_method_ptrs = calloc( sizeof(InstanceMethodsSQLiteDB), 1 );
        ClassSQLiteDB_AssignInstanceMethodPointers( sqlite_db_instance_method_ptrs);
